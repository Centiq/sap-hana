...
1. :warning: NOT MOUNTING BLOBS Create a copy of the `inifile.params` to the `sapbits` container  to the `/templates/` directory and rename to `pas.inifile.params` or `aas.inifile.params` as appropriate:
